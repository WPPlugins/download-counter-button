...
<form method="post" action="options.php">
    ...
    <p>
        <input type="checkbox" 
               name="melibuPlugin_get_download_button_top[top]" 
               id="melibuPlugin_get_download_button_top1" 
               value="show" 
               class="mb_switch" 
               <?php checked($settings['topfive'], 'show'); ?> />
        <label for="melibuPlugin_get_download_button_top1"><?php _e('Turn', 'download-counter-button'); ?></label>
    </p>
    <p>
        <input type="submit" 
